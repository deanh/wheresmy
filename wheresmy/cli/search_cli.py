...
def print_command_help():
    ...
    print("  search_cli.py search --year 2018")
    print("  # Search for all images taken with Apple devices")
    print("  search_cli.py search --camera-make Apple")
    print("  # Search for high-resolution images")
    print("  search_cli.py search --min-width 3000 --min-height 2000")
    print("  # Combined search")
    print("  search_cli.py search --camera-make Apple --year 2018 --min-width 3000")
    print("  # Show database statistics")
    print("  search_cli.py stats")
    print("  # Show details for a specific image")
    print("  search_cli.py image 123")
    print("\nFor complete command details, use: search_cli.py <command> --help")
    print("")
