    ...
    def test_generate_description_structure(self):
        ...
        class TestSmolVLM(SmolVLMDescriber):
            def initialize_model(self):
                ...
                self.processor.batch_decode = MagicMock(return_value=["User:<image>Prompt\nAssistant: This is a test description"])
                self.processor.return_value = {"input_ids": MagicMock(), "pixel_values": MagicMock()}
