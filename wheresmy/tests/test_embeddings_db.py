...
class TestEmbeddingsDatabase(unittest.TestCase):
    ...
    def test_add_embedding(self):
        ...
        self.assertEqual(retrieved["embedding_size"], self.test_embedding["embedding_size"])
        
        # Check the embedding array
        np.testing.assert_allclose(retrieved["embedding"], self.test_embedding["embedding"])
    
    def test_batch_add_embeddings(self):
        """Test adding multiple embeddings at once."""
        # Create multiple test embeddings
        embeddings_dict = {
            self.image_id: self.test_embedding
        }
