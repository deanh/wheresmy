...
def sample_files(source_folder, destination_folder, sample_size):
    ...
    if sample_size > len(all_files):
        ...
        print(f"Sample size adjusted to {sample_size} (total number of files available)")
...
if __name__ == "__main__":
    sample_files("/mnt/cfdd0ae1-0c7a-4e06-b98a-c7d8977986aa/Dropbox/Camera Uploads", "sample_directory", 10)